...
TWILIO_DIRECT_CALL_RECORD = os.getenv("TWILIO_DIRECT_CALL_RECORD")
...
ZAPIER_WEBHOOK_LINKEDIN_URL = os.getenv("ZAPIER_WEBHOOK_LINKEDIN_URL")
...
GOOGLE_ADS_WEBHOOK_URL = os.getenv("GOOGLE_ADS_WEBHOOK_URL")
GOOGLE_ADS_INSIGHTS_URL = os.getenv("GOOGLE_ADS_INSIGHTS_URL")
...
AUTO_LOGIN_SECRET = os.getenv("AUTO_LOGIN_SECRET")

EXTERNAL_PATIENT_BASE_URL = os.getenv("EXTERNAL_PATIENT_BASE_URL")

EXTERNAL_PATIENT_USERNAME = os.getenv("EXTERNAL_PATIENT_USERNAME")

EXTERNAL_PATIENT_PASSWORD = os.getenv("EXTERNAL_PATIENT_PASSWORD")

EXTERNAL_PATIENT_CLINIC_ID = int(os.getenv("EXTERNAL_PATIENT_CLINIC_ID", "1"))
