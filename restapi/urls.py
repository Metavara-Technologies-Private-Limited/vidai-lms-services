...
from restapi.views.social_auth_views import (
    ...
    LinkedInAdsAccountsAPIView,
    LinkedInCampaignsAPIView,
    LinkedInCampaignAnalyticsAPIView,
    LinkedInFullAnalyticsAPIView,
...
from restapi.views.social_campaign_views import (
    SocialMediaCampaignCreateAPIView,
    LinkedInCampaignInsightsAPIView,
    LinkedInCampaignStatusAPIView,
    LinkedInCampaignUpdateAPIView,
)

from restapi.views.webhook_views import (
    LinkedInZapierCallbackAPIView,
    GoHighLevelLeadWebhookAPIView,
)
...
# CLINICS
# =====================================================
path("clinics/", ClinicCreateAPIView.as_view()),
path("clinics/<int:clinic_id>/", ClinicUpdateAPIView.as_view()),
path("clinics/<int:clinic_id>/detail/", GetClinicView.as_view()),
path("clinics/search/", ClinicSearchAPIView.as_view()),
...
# EMPLOYEES
# =====================================================
path("clinics/<int:clinic_id>/employees/", ClinicEmployeesAPIView.as_view()),
path("employees/", EmployeeCreateAPIView.as_view()),
path("employees/<int:employee_id>/update/", EmployeeUpdateAPIView.as_view()),
...
path("leads/<uuid:lead_id>/update/", LeadUpdateAPIView.as_view()),
path("leads/list/", LeadListAPIView.as_view()),
path("leads/<uuid:lead_id>/", LeadGetAPIView.as_view()),
path("leads/<uuid:lead_id>/activate/", LeadActivateAPIView.as_view()),
path("leads/<uuid:lead_id>/inactivate/", LeadInactivateAPIView.as_view()),
path("leads/<uuid:lead_id>/delete/", LeadSoftDeleteAPIView.as_view()),
path("lead-email/", LeadEmailAPIView.as_view()),
path("lead-mail/", LeadMailListAPIView.as_view()),


# =====================================================
# LEAD NOTES
# =====================================================
path("leads/notes/", LeadNoteCreateAPIView.as_view()),
path("leads/notes/<uuid:note_id>/update/", LeadNoteUpdateAPIView.as_view()),
path("leads/notes/<uuid:note_id>/delete/", LeadNoteDeleteAPIView.as_view()),
path("leads/<uuid:lead_id>/notes/", LeadNoteListAPIView.as_view()),
...
path("twilio/sms-status-callback/", TwilioSMSStatusCallbackAPIView.as_view()),
path("twilio/call-status-callback/", TwilioCallStatusCallbackAPIView.as_view()),
path("twilio/sms/", TwilioMessageListAPIView.as_view()),
path("twilio/calls/", TwilioCallListAPIView.as_view()),
...
path("campaigns/list/", CampaignListAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/", CampaignGetAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/update/", CampaignUpdateAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/activate/", CampaignActivateAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/inactivate/", CampaignInactivateAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/delete/", CampaignSoftDeleteAPIView.as_view()),

path("social-media-campaign/create/", SocialMediaCampaignCreateAPIView.as_view()),

path("campaigns/email/create/", EmailCampaignCreateAPIView.as_view()),
path("campaigns/save-mailchimp-id/", EmailSaveMailchimpCampaignIdAPIView.as_view()),
path("campaigns/zapier-callback/", CampaignZapierCallbackAPIView.as_view()),

path("campaigns/<uuid:campaign_id>/facebook-insights/", CampaignFacebookInsightsAPIView.as_view()),
path("campaigns/<uuid:campaign_id>/facebook-debug/", FacebookDebugAPIView.as_view()),

path("campaigns/<uuid:campaign_id>/mailchimp-insights/", CampaignMailchimpInsightsAPIView.as_view()),
path("mailchimp/insights-callback/", MailchimpInsightsCallbackAPIView.as_view()),
path("mailchimp/webhook/", MailchimpWebhookAPIView.as_view()),


# =====================================================
# LINKEDIN CAMPAIGN CONTROL (NEW)
# =====================================================
path(
    "social/campaign/insights/",
    LinkedInCampaignInsightsAPIView.as_view(),
    name="linkedin-campaign-insights"
),

path(
    "social/campaign/status/",
    LinkedInCampaignStatusAPIView.as_view(),
    name="linkedin-campaign-status"
),

path(
    "social/campaign/update/",
    LinkedInCampaignUpdateAPIView.as_view(),
    name="linkedin-campaign-update"
),
...
# PIPELINES
# =====================================================
path("pipelines/create/", PipelineCreateAPIView.as_view()),
path("pipelines/", PipelineListAPIView.as_view()),
path("pipelines/<uuid:pipeline_id>/", PipelineDetailAPIView.as_view()),
path("pipelines/stages/create/", PipelineStageCreateAPIView.as_view()),
path("pipelines/stages/<uuid:stage_id>/update/", PipelineStageUpdateAPIView.as_view()),
path("pipelines/stages/<uuid:stage_id>/rules/", StageRuleSaveAPIView.as_view()),
path("pipelines/stages/<uuid:stage_id>/fields/", StageFieldSaveAPIView.as_view()),
...
path("tickets/create/", TicketCreateAPIView.as_view()),
path("tickets/dashboard-count/", TicketDashboardCountAPIView.as_view()),
path("tickets/<uuid:ticket_id>/", TicketDetailAPIView.as_view()),
path("tickets/<uuid:ticket_id>/update/", TicketUpdateAPIView.as_view()),
path("tickets/<uuid:ticket_id>/assign/", TicketAssignAPIView.as_view()),
path("tickets/<uuid:ticket_id>/status/", TicketStatusUpdateAPIView.as_view()),
path("tickets/<uuid:ticket_id>/documents/", TicketDocumentUploadAPIView.as_view()),
path("tickets/<uuid:ticket_id>/delete/", TicketDeleteAPIView.as_view()),
path("tickets/<uuid:ticket_id>/reply/", TicketReplyAPIView.as_view()),


# =====================================================
# LABS
# =====================================================
path("labs/", LabListAPIView.as_view()),
path("labs/create/", LabCreateAPIView.as_view()),
path("labs/<uuid:lab_id>/update/", LabUpdateAPIView.as_view()),
path("labs/<uuid:lab_id>/delete/", LabSoftDeleteAPIView.as_view()),


# =====================================================
# TEMPLATES
# =====================================================
path("templates/<str:template_type>/", TemplateListAPIView.as_view()),
path("templates/<str:template_type>/create/", TemplateCreateAPIView.as_view()),
path("templates/<str:template_type>/<uuid:template_id>/", TemplateDetailAPIView.as_view()),
path("templates/<str:template_type>/<uuid:template_id>/update/", TemplateUpdateAPIView.as_view()),
path("templates/<str:template_type>/<uuid:template_id>/delete/", TemplateDeleteAPIView.as_view()),


# =====================================================
# UPLOAD
# =====================================================
path("upload/image/", ImageUploadAPIView.as_view()),


# =====================================================
# INTERACTIONS
# =====================================================
path("interactions/counts/", InteractionCountsAPIView.as_view()),


# =====================================================
# DEBUG
# =====================================================
path("debug/twilio-status/", TwilioDebugAPIView.as_view()),
path("debug/mail-insights-log/", MailInsightsDebugAPIView.as_view()),


# =====================================================
# LINKEDIN AUTH + ANALYTICS
# =====================================================
path("linkedin/login/", LinkedInLoginAPIView.as_view()),
path("linkedin/callback/", LinkedInCallbackAPIView.as_view()),
path("linkedin/status/", LinkedInStatusAPIView.as_view()),

path("linkedin/ad-accounts/", LinkedInAdsAccountsAPIView.as_view()),
path("linkedin/campaigns/", LinkedInCampaignsAPIView.as_view()),
path("linkedin/campaign-analytics/", LinkedInCampaignAnalyticsAPIView.as_view()),
path("linkedin/full-analytics/", LinkedInFullAnalyticsAPIView.as_view()),
...
path("facebook/disconnect/", FacebookDisconnectAPIView.as_view()),
...
path("google/callback/", GoogleCallbackAPIView.as_view()),
path(
    "clinics/<int:clinic_id>/social-accounts/",
    SocialAccountListAPIView.as_view()
),
...
# FACEBOOK ADS
# =====================================================
path("fb/campaigns/", FBCampaignListAPIView.as_view()),
path("fb/campaigns/create/", FBCampaignCreateAPIView.as_view()),
path("fb/campaigns/<str:campaign_id>/insights/", FBCampaignInsightsAPIView.as_view()),
...
path(
    "google-ads/create/",
    GoogleAdsCampaignCreateAPIView.as_view(),
),

path(
    "google-ads/status/",
    GoogleAdsCampaignStatusAPIView.as_view(),
),

path(
    "google-ads/callback/",
    GoogleAdsCampaignCallbackAPIView.as_view(),
),

path(
    "google-ads/insights/",
    GoogleAdsInsightsAPIView.as_view(),
),
...
# =====================================================
path(
    "campaign/insights/trigger/",
    CampaignInsightsTriggerAPIView.as_view(),
),

path(
    "campaign/insights/callback/",
    CampaignInsightsCallbackAPIView.as_view(),
),
...
# =====================================================
path(
    "webhooks/gohighlevel/lead/",
    GoHighLevelLeadWebhookAPIView.as_view(),
),

path(
    "webhooks/linkedin-zapier-callback/",
    LinkedInZapierCallbackAPIView.as_view(),
),
...
# REPUTATION
# =====================================================
path("reputation/requests/create/", ReviewRequestCreateAPIView.as_view()),
path("reputation/requests/", ReviewRequestListAPIView.as_view()),
path("reputation/requests/<uuid:request_id>/", ReviewRequestDetailAPIView.as_view()),
path("reputation/dashboard/", ReputationDashboardAPIView.as_view()),
path("reputation/reviews/create/", ReviewCreateAPIView.as_view()),


# =====================================================
# REFERRALS / REPORTS
# =====================================================
path("sources/", ReferralSourceListAPIView.as_view()),
path("dashboard/", ReferralDashboardAPIView.as_view()),
path("reports/calls/", CallReportView.as_view()),
path("reports/campaigns/", CampaignReportView.as_view()),


# =====================================================
# PROXY
# =====================================================
path("proxy/login/", LoginProxyAPIView.as_view()),
path("me/profile/", ProfileProxyAPIView.as_view()),
path("users-search/", UsersProxyAPIView.as_view()),
